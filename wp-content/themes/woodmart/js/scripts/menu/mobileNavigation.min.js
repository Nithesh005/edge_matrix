      ...
      d.append('<span class="wd-nav-opener"></span>'),
        o.on("click", ".wd-nav-opener", function (e) {
          ...
          e.hasClass("opener-page")
            ? (e.removeClass("opener-page").find("> ul").slideUp(200),
              e
                .removeClass("opener-page")
                .find(
                  ".wd-dropdown-menu .container > ul, .wd-dropdown-menu > ul"
                )
                .slideUp(200),
              e.find("> .wd-nav-opener").removeClass("wd-active"))
            : (e.addClass("opener-page").find("> ul").slideDown(200),
              e
        ...
        e.on(
          "click",
          ".mobile-nav .login-side-opener, .mobile-nav .close-side-widget",
          function () {
            woodmartThemeModule.closeMobileNavigation();
          }
        );
