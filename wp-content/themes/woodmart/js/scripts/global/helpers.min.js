...
!(function (i) {
  ...
  (woodmartThemeModule.$window = i(window)),
    (woodmartThemeModule.$document = i(document)),
    (woodmartThemeModule.$body = i("body")),
    ...
    (woodmartThemeModule.removeDuplicatedStylesFromHTML = function (e, a) {
      var r = i('<div class="temp-wrapper"></div>').append(e),
        s = r.find("link"),
        l = 0,
        m = !1;
      0 === s.length || "yes" === woodmart_settings.combined_css
        ? a(e)
        : (setTimeout(function () {
            l <= s.length && !m && (a(i(r.html())), (m = !0));
          }, 500),
          s.each(function () {
            -1 !== i(this).attr("id").indexOf("theme_settings_") &&
              i("head")
                .find(
          ...
          s.each(function () {
            var e = i(this),
              o = e.attr("id"),
              t = e.attr("href"),
              n = -1 !== o.indexOf("theme_settings_"),
              d = -1 !== o.indexOf("theme_settings_default");
            e.remove(),
              void 0 !== woodmart_page_css[o] || d
                ? ++l >= s.length && !m && (a(i(r.html())), (m = !0))
                : i("head").append(
                    e.on("load", function () {
                      l++,
                        n || (woodmart_page_css[o] = t),
                        l >= s.length && !m && (a(i(r.html())), (m = !0));
                    })
                  );
          }));
    ...
    (woodmartThemeModule.setupMainCarouselArg = function () {
      woodmartThemeModule.$mainCarouselWrapper = i(
      ...
      (woodmartThemeModule.$mainCarouselWrapper.hasClass(
        ...
        (woodmartThemeModule.mainCarouselArg = {
          ...
          startPosition: woodmartThemeModule.$mainCarouselWrapper.hasClass(
            "thumbs-position-centered"
          )
            ? woodmart_settings.centered_gallery_start
            : 0,
          dots: "yes" === woodmart_settings.product_slider_dots,
          nav: !0,
    ...
    woodmartThemeModule.$window.on("elementor/frontend/init", function () {
      elementorFrontend.isEditMode() &&
        ...
        (elementorFrontend.hooks.addAction(
          "frontend/element_ready/section",
          function (e) {
            var o = e.data("model-cid");
            void 0 === elementorFrontend.config.elements.data[o] ||
              elementorFrontend.config.elements.data[o].attributes.content_width
                .size ||
              e.addClass("wd-negative-gap");
          }
        ),
        elementor.channels.editor.on("change:section", function (e) {
          var o = e.elementSettingsModel.changed;
          void 0 !== o.content_width &&
            ((e = e._parent.model.id),
            (e = i(".elementor-element-" + e)),
            o.content_width.size
    ...
    woodmartThemeModule.$window.on("load", function () {
      i(".wd-preloader")
        ...
        i(".wd-preloader-style").remove(),
        setTimeout(function () {
          i(".wd-preloader").remove();
        }, 200);
    });
})(jQuery),
